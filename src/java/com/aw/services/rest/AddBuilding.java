...
private String errorMessage;
    ...
    /**
     * Creates a new instance of AddBuilding
     */
    public AddBuilding() {
    }

    /**
     * Retrieves representation of an instance of com.aw.services.rest.AddBuilding
     * @param data
     * @param token
    ...
    public String addBuilding(@FormParam("data") String data,
        ...
        try {
            if(isAllowed && validate(data)) {
                ...
                return AncientWarServiceImpl.getInstance().addBuilding(inputData).toString();
            }
            else {
    ...
    private boolean validate(String data) {
        ...
        try {
            ...
            if(!object.has("uid") || !object.has("tid") || !object.has("level")) {
                errorMessage = "Data is missing, Please check uid, tid & level.";
                valid = false;
                return valid;
            }
        }
